<div id="content">
  ...
  <h2><?php echo _('Named, anonymous accounts'); ?></h2>
  <p><?php echo _('On Occupy.here you post anonymously like with weblog comments. You have a named account, but there is no password or verification process. Content you post here may be copied to other Occupy.here wifi routers.'); ?></p>
  <h2><?php echo _('Help us build Occupy.here'); ?></h2>
  <p><?php echo _('Occupy.here is all-volunteer'); ?>, <a href="https://github.com/dphiffer/occupy.here" class="off-site"><?php echo _('open source'); ?></a>, <?php echo _('and'); ?> <a href="http://www.fsf.org/" class="off-site"><?php echo _('Free Software'); ?></a>. <a href="http://phiffer.org/" class="off-site">Dan Phiffer</a> <?php echo _('is the founder and lead developer, with contributions from'); ?> <a href="http://boxysean.com/" class="off-site">Sean McIntyre</a> <?php echo _('and GitHub user'); ?> <a href="https://github.com/Phaeilo" class="off-site">Phaeilo</a>. <?php echo _('In 2012 the project was fortunate to receive a commissions grant from'); ?> <a href="http://rhizome.org/" class="off-site">Rhizome</a>.</p>
  <h2><?php echo _('Setting up your own router'); ?></h2>
  <p><?php echo _('Occupy.here is designed to be replicated. You can install the custom OpenWRT image on your own router. Visit'); ?> <a href="http://occupyhere.org" class="off-site">occupyhere.org</a> <?php echo _('for the step-by-step installation guide.'); ?></p>
</div>
